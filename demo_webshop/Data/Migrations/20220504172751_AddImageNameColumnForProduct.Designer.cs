...
namespace demo_webshop.Data.Migrations
{
    ...
    [Migration("20220504172751_AddImageNameColumnForProduct")]
    partial class AddImageNameColumnForProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("demo_webshop.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("demo_webshop.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("demo_webshop.Models.Order", b =>
                {
                    b.HasOne("demo_webshop.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("demo_webshop.Models.ProductCategory", b =>
                {
                    b.HasOne("demo_webshop.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("demo_webshop.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
